    ...
    : POSIXApplication(argc, argv)
{
    ...
    // Added a -l flag to be registered into the command in order to display priority
    parser().registerFlag('l', "priority", "Displays priority level of processes");
}
